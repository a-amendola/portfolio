      ...
      <div className="intro-container">
        ...
        <div className="intro-text">
            ...
            <div className="intro-paragraphs">
                <p>I graduated from Penn State with degrees in computer science and economics. During one of my internships, I fell in love with frontend development, as there's something magical about combining my technical knowledge with my creative side.</p>
                ...
                <p>So I started freelancing. Now I design and build websites for small businesses while traveling the world. I'm living proof that you can chase multiple dreams at once — and that taking the leap, even when you're terrified, is always worth it.</p>
            </div>
            <a href="/resume.pdf" target="_blank" rel="noopener noreferrer" className='a-bubble'><h4>View my full resume →</h4></a>
        </div>
      </div>
    </section>
  );
